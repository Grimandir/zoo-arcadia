...
<head>
    ...
    <title>Modifier un Habitat - Zoo Arcadia</title>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="edit_habitat.php?id=<?php echo htmlspecialchars($id); ?>">Modifier Habitat
    ...
    <div class="container mt-4">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="description" name="description" rows="4" required><?php echo htmlspecialchars($habitat['description']); ?></textarea>
            </div>
