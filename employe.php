...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#">Zoo Arcadia - Employé</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="employe.php">Accueil <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="validate_reviews.php">Valider Avis</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="add_feeding.php">Ajouter Nourriture</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container mt-4">
        ...
        <p>Utilisez le menu ci-dessus pour gérer les avis et les nourrir les animaux.</p>
    </div>
